...
用法::
    ...
    python scripts/dev/product_readiness_check.py
    python scripts/dev/product_readiness_check.py --json
"""
    ...
    return [
        DimensionScore(
            ...
            checks=[
                ...
                ("run_demo 默认 travel", 'DEFAULT_DOMAIN = "travel"' in (ROOT / "scripts/run_demo.py").read_text(encoding="utf-8")),
        ...
        DimensionScore(
            ...
            checks=[
                ...
                ("Chroma KB + ingest CLI", _exists("scripts/dev/ingest_knowledge.py")),
                ("KB recall benchmark", _exists("scripts/dev/benchmark_knowledge_recall.py")),
                ...
                ("semver sync script", _exists("scripts/dev/sync_package_versions.py")),
            ],
        ),
        DimensionScore(
            name="orchestration",
        ...
        DimensionScore(
            ...
            checks=[
                ...
                ("travel 主示例叙事", "主示例" in (ROOT / "docs/domains.md").read_text(encoding="utf-8")),
                ("run_demo 默认 travel", 'DEFAULT_DOMAIN = "travel"' in (ROOT / "scripts/run_demo.py").read_text(encoding="utf-8")),
        ...
        DimensionScore(
            ...
            target_pct=92,
            checks=[
                ("domain locales JSON", _exists("domains/travel/locales/en.json")),
