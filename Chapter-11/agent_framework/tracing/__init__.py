...
Span 命名规范（latc）：
    ...
    latc.{OTEL_SERVICE_NAME}.a2a.call
    latc.{OTEL_SERVICE_NAME}.a2a.server.invoke
    latc.{OTEL_SERVICE_NAME}.handoff.completed (event)

环境变量：
  OTEL_SERVICE_NAME          服务名（默认 multi-agent-platform）
