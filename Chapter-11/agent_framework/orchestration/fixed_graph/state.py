...
class CentralAgentState(TypedDict, total=False):
    ...
    # --- Ch2 思维链预调查 ---
    prefilled_pre_survey: Dict[str, Any]  # RouterEngine 预填，跳过 run_pre_survey LLM
    ...
    # --- Ch4 任务拆解 + Ch6 子智能体路由 ---
    prefilled_execution_plan: Dict[str, Any]  # RouterEngine 预填，build_plan 跳过 TaskPlanner
