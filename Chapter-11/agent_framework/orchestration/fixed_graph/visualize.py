...
from agent_framework.config import GRAPH_OUTPUT_DIR

DEFAULT_OUTPUT_DIR = GRAPH_OUTPUT_DIR
...
class GraphVisualizer:
    ...
    def from_compiled(cls, app: Any) -> "GraphVisualizer":
        """从 LangGraphOrchestrator.app 创建。"""
        return cls(app)

    @classmethod
    def standalone(cls) -> "GraphVisualizer":
        """无需 API Key，仅编译空图结构用于文档导出。"""
