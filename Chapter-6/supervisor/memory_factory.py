...
from memory_system import LongTermMemory, ThreadShortTermMemory
from prompts import MEMORY_PROMPT_TEMPLATE
...
def resolve_memory_backend(explicit: Optional[str] = None) -> LongTermBackend:
    ...
    if raw in ("store", "langgraph", "langgraph_store"):
        return "store"
    return "chroma"
...
class StoreLongTermMemory:
    ...
    def __init__(
        ...
        self.namespace = ("chapter6_memories", user_id)
